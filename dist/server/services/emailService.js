...
exports.emailService = {
     ...
     */
    getGuestCredentialsContent: async (name, password) => {
        try {
     ...
     */
    getBookingConfirmationContent: async (name, serviceName, date, time, isGuest) => {
     ...
     */
    getBookingReminderContent: async (name, serviceName, date, time) => {
     ...
     */
    getBookingCompletionContent: async (name, serviceName) => {
        try {
            const template = await prisma_1.default.notificationTemplate.findUnique({
     ...
     */
    getBirthdayGreetingContent: async (name) => {
        try {
            const template = await prisma_1.default.notificationTemplate.findUnique({
     ...
     */
    getPaymentReceiptContent: async (name, amount, date, paymentId) => {
        try {
            const template = await prisma_1.default.notificationTemplate.findUnique({
     ...
     */
    getEasterGreetingContent: async (name) => {
        try {
            const template = await prisma_1.default.notificationTemplate.findUnique({
