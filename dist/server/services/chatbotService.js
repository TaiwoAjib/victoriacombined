...
exports.processMessage = exports.getSystemPrompt = void 0;
const openai_1 = __importDefault(require("openai"));
const prisma_1 = __importDefault(require("../utils/prisma"));
const apiKey = process.env.OPENROUTER_API_KEY || process.env.OPENAI_API_KEY;
const baseURL = process.env.OPENAI_BASE_URL ||
    (process.env.OPENROUTER_API_KEY ? 'https://openrouter.ai/api/v1' : undefined);
const openRouterHeaders = process.env.OPENROUTER_SITE_URL || process.env.OPENROUTER_APP_NAME
    ? {
...
const processMessage = async (userMessage) => {
    ...
    try {
        const systemPrompt = await (0, exports.getSystemPrompt)();
